...
describe 'TechnoFinder Application' do
  ...
  describe "/send_text_message.json" do
    ...
    it "should ask to send a text message" do
      ...
      last_response.body.should == "{\"tropo\":[{\"message\":{\"to\":\"6615551212\",\"network\":\"SMS\",\"say\":{\"value\":\"Location:1701 N. Milwaukee Avenue Type:Chicago Public Library Hours:M-W: 12PM-8PM; TU, TH: 10AM-6PM; F-SA: 9AM-5PM; SU: Closed Phone:(312) 744-6022 Appointment:NA Internet:Yes WiFi:Yes Training:No \"}}},{\"say\":[{\"value\":\"Message sent.\"}]},{\"on\":{\"event\":\"continue\",\"next\":\"/goodbye.json\"}},{\"on\":{\"event\":\"hangup\",\"next\":\"/hangup.json\"}}]}"
    end
  end
