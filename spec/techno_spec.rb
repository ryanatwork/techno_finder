...
describe 'TechnoFinder Application' do
  ...
  describe "/send_text_message.json" do
    ...
    it "should ask to send a text message" do
      ...
      last_response.body.should == "{\"tropo\":[{\"message\":{\"to\":\"6615551212\",\"network\":\"SMS\",\"say\":{\"value\":\"Information about location Bucktown-Wicker Park is as follows: Location: 1701 N. Milwaukee Avenue Hours: M to W: 12PM to 8PM; TU, TH: 10AM to 6PM; F to SA: 9AM to 5PM; SU: Closed Phone: (312) 744-6022\"}}},{\"say\":[{\"value\":\"Message sent.\"}]},{\"on\":{\"event\":\"continue\",\"next\":\"/goodbye.json\"}},{\"on\":{\"event\":\"hangup\",\"next\":\"/hangup.json\"}}]}"
    end
  end
